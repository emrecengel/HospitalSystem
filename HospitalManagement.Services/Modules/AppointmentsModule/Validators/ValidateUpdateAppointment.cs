...
internal class ValidateUpdateAppointment : AbstractValidator<UpdateAppointment>
{
    public ValidateUpdateAppointment(IRepository<Doctor> doctorRepository, IRepository<Patient> patientRepository, IRepository<Appointment> repository)
    {
